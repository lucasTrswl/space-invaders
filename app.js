...
function remove() {
  ...
  // Déplace l'espace en fonction de la touche pressée par le joueur
  function moveShooter(e) {
    squares[currentShooterIndex].classList.remove('shooter')
    switch(e.key) {
      case 'ArrowLeft': // Si la flèche gauche est pressée
        // Si l'index de la case actuelle de l'espace n'est pas un multiple de la largeur de la grille, on déplace l'espace vers la gauche
        if (currentShooterIndex % width !== 0) currentShooterIndex -=1
        break
      case 'ArrowRight' : // Si la flèche droite est pressée
        // Si l'index de la case actuelle de l'espace n'est pas un multiple de la largeur de la grille - 1, on déplace l'espace vers la droite
